...
async function updateSession(request: NextRequest) {
  ...
  // /portal/restablecer NO va aquí: es una página protegida normal (requiere
  // sesión) — la sesión que la protege es justo la de recovery que
  // /auth/callback acaba de crear tras el enlace del email.
  const isAuthRoute =
    path === "/portal/login" ||
